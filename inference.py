...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        distribution = [count[1] for count in items]
        values = [count[0] for count in items]
        draw = random.random()
        count = 0
        distribution[0] = 0
        while draw > total:
...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Commands to run : python autograder.py -q q1
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.allPositions: # Possible Ghost Locations
    ...
    def elapseTime(self, gameState):
        ...
        dist = DiscreteDistribution()
        for oldPos in self.allPositions: # Possible Ghost Locations
